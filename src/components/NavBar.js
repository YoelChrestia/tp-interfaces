...
const NavBar = () => {
    ...
    return (
        <Stack bgColor={colors.blue5} w={'100%'} height={'150px'} borderRadius={borders.borderRadius} p={8} direction={direction} color="white" >
            <Image src="/images/logo.svg" alt="logo" width={'80px'} height={'80px'} />
           <Stack direction={direction} align={'center'} w={'100%'} justify={'center'} pr={36} gap={10}>
