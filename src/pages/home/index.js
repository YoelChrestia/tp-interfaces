...
const Home = () => {
  ...
  >
    ...
    <Stack 
      ...
      borderRadius={"12px"}
      >
        <Text>Revisar las notas de matematica de 2do, hubo un problema con la nota de quimey lopez</Text>
        </Stack>
      <Stack
      px={5}
      py={2}
    ...
    > 
      ...
      <Stack direction={direction === "row" ? "row" : "column"} justify={"space-between"} gap={direction === "row" ? 0 : 2}>
      <Image src="/images/calendar.png" width={direction === "row" ? "60%" : "100%"} borderRadius="12px"></Image>
